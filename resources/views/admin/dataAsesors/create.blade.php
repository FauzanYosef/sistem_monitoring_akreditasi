...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dataAsesor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-asesors.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="nip_assesor">{{ trans('cruds.dataAsesor.fields.nip_assesor') }}</label>
                <input class="form-control {{ $errors->has('nip_assesor') ? 'is-invalid' : '' }}" type="text" name="nip_assesor" id="nip_assesor" value="{{ old('nip_assesor', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_asesor') ? 'is-invalid' : '' }}" type="text" name="nama_asesor" id="nama_asesor" value="{{ old('nama_asesor', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_assesor') ? 'is-invalid' : '' }}" type="email" name="email_assesor" id="email_assesor" value="{{ old('email_assesor') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telp_asesor') ? 'is-invalid' : '' }}" type="text" name="telp_asesor" id="telp_asesor" value="{{ old('telp_asesor', '') }}">
