...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dataPt.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-pts.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="kode_pt">{{ trans('cruds.dataPt.fields.kode_pt') }}</label>
                <input class="form-control {{ $errors->has('kode_pt') ? 'is-invalid' : '' }}" type="number" name="kode_pt" id="kode_pt" value="{{ old('kode_pt', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_pt') ? 'is-invalid' : '' }}" type="text" name="nama_pt" id="nama_pt" value="{{ old('nama_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('jenis_pt') ? 'is-invalid' : '' }}" name="jenis_pt" id="jenis_pt">
                    ...
                    @foreach(App\Models\DataPt::JENIS_PT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('jenis_pt', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('jenis_pengelolaan') ? 'is-invalid' : '' }}" name="jenis_pengelolaan" id="jenis_pengelolaan">
                    ...
                    @foreach(App\Models\DataPt::JENIS_PENGELOLAAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('jenis_pengelolaan', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_pt') ? 'is-invalid' : '' }}" name="status_pt" id="status_pt">
                    ...
                    @foreach(App\Models\DataPt::STATUS_PT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_pt', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat_pt') ? 'is-invalid' : '' }}" name="alamat_pt" id="alamat_pt">{{ old('alamat_pt') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_telp_pt') ? 'is-invalid' : '' }}" type="text" name="no_telp_pt" id="no_telp_pt" value="{{ old('no_telp_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_pt') ? 'is-invalid' : '' }}" type="email" name="email_pt" id="email_pt" value="{{ old('email_pt') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('web_pt') ? 'is-invalid' : '' }}" type="text" name="web_pt" id="web_pt" value="{{ old('web_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_sk_pendirian_pt') ? 'is-invalid' : '' }}" type="text" name="no_sk_pendirian_pt" id="no_sk_pendirian_pt" value="{{ old('no_sk_pendirian_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tgl_sk_pendirian_pt') ? 'is-invalid' : '' }}" type="text" name="tgl_sk_pendirian_pt" id="tgl_sk_pendirian_pt" value="{{ old('tgl_sk_pendirian_pt') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peringkat_akre_pt') ? 'is-invalid' : '' }}" type="text" name="peringkat_akre_pt" id="peringkat_akre_pt" value="{{ old('peringkat_akre_pt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_sk_banpt') ? 'is-invalid' : '' }}" type="text" name="no_sk_banpt" id="no_sk_banpt" value="{{ old('no_sk_banpt', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ts_pt') ? 'is-invalid' : '' }}" type="text" name="ts_pt" id="ts_pt" value="{{ old('ts_pt', '') }}">
                @if($errors->has('ts_pt'))
