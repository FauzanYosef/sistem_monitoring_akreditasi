...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.kodeprodi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.kodeprodis.update", [$kodeprodi->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="kode_prodi">{{ trans('cruds.kodeprodi.fields.kode_prodi') }}</label>
                <input class="form-control {{ $errors->has('kode_prodi') ? 'is-invalid' : '' }}" type="text" name="kode_prodi" id="kode_prodi" value="{{ old('kode_prodi', $kodeprodi->kode_prodi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_prodi') ? 'is-invalid' : '' }}" type="text" name="nama_prodi" id="nama_prodi" value="{{ old('nama_prodi', $kodeprodi->nama_prodi) }}">
