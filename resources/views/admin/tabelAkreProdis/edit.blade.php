...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tabelAkreProdi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tabel-akre-prodis.update", [$tabelAkreProdi->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_akreditasi') ? 'is-invalid' : '' }}" name="status_akreditasi" id="status_akreditasi">
                    ...
                    @foreach(App\Models\TabelAkreProdi::STATUS_AKREDITASI_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_akreditasi', $tabelAkreProdi->status_akreditasi) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_doktor') ? 'is-invalid' : '' }}" type="number" name="jml_doktor" id="jml_doktor" value="{{ old('jml_doktor', $tabelAkreProdi->jml_doktor) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_magister') ? 'is-invalid' : '' }}" type="number" name="jml_magister" id="jml_magister" value="{{ old('jml_magister', $tabelAkreProdi->jml_magister) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_sarjana') ? 'is-invalid' : '' }}" type="number" name="jml_sarjana" id="jml_sarjana" value="{{ old('jml_sarjana', $tabelAkreProdi->jml_sarjana) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_profesi_2') ? 'is-invalid' : '' }}" type="number" name="jml_profesi_2" id="jml_profesi_2" value="{{ old('jml_profesi_2', $tabelAkreProdi->jml_profesi_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_profesi_1') ? 'is-invalid' : '' }}" type="number" name="jml_profesi_1" id="jml_profesi_1" value="{{ old('jml_profesi_1', $tabelAkreProdi->jml_profesi_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_profesi') ? 'is-invalid' : '' }}" type="number" name="jml_profesi" id="jml_profesi" value="{{ old('jml_profesi', $tabelAkreProdi->jml_profesi) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_vokasi_1') ? 'is-invalid' : '' }}" type="number" name="jml_vokasi_1" id="jml_vokasi_1" value="{{ old('jml_vokasi_1', $tabelAkreProdi->jml_vokasi_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_vokasi_2') ? 'is-invalid' : '' }}" type="number" name="jml_vokasi_2" id="jml_vokasi_2" value="{{ old('jml_vokasi_2', $tabelAkreProdi->jml_vokasi_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_vokasi_4') ? 'is-invalid' : '' }}" type="number" name="jml_vokasi_4" id="jml_vokasi_4" value="{{ old('jml_vokasi_4', $tabelAkreProdi->jml_vokasi_4) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_vokasi_5') ? 'is-invalid' : '' }}" type="number" name="jml_vokasi_5" id="jml_vokasi_5" value="{{ old('jml_vokasi_5', $tabelAkreProdi->jml_vokasi_5) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_vokasi_6') ? 'is-invalid' : '' }}" type="number" name="jml_vokasi_6" id="jml_vokasi_6" value="{{ old('jml_vokasi_6', $tabelAkreProdi->jml_vokasi_6) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_vokasi_7') ? 'is-invalid' : '' }}" type="number" name="jml_vokasi_7" id="jml_vokasi_7" value="{{ old('jml_vokasi_7', $tabelAkreProdi->jml_vokasi_7) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number" name="total" id="total" value="{{ old('total', $tabelAkreProdi->total) }}" step="1">
                @if($errors->has('total'))
