...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tabelJabatanDosen.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tabel-jabatan-dosens.update", [$tabelJabatanDosen->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('pendidikan') ? 'is-invalid' : '' }}" name="pendidikan" id="pendidikan">
                    ...
                    @foreach(App\Models\TabelJabatanDosen::PENDIDIKAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('pendidikan', $tabelJabatanDosen->pendidikan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gr_besar') ? 'is-invalid' : '' }}" type="number" name="gr_besar" id="gr_besar" value="{{ old('gr_besar', $tabelJabatanDosen->gr_besar) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lektor_kepala') ? 'is-invalid' : '' }}" type="number" name="lektor_kepala" id="lektor_kepala" value="{{ old('lektor_kepala', $tabelJabatanDosen->lektor_kepala) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lektor') ? 'is-invalid' : '' }}" type="number" name="lektor" id="lektor" value="{{ old('lektor', $tabelJabatanDosen->lektor) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asisten_ahli') ? 'is-invalid' : '' }}" type="number" name="asisten_ahli" id="asisten_ahli" value="{{ old('asisten_ahli', $tabelJabatanDosen->asisten_ahli) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tenaga_pengajar') ? 'is-invalid' : '' }}" type="number" name="tenaga_pengajar" id="tenaga_pengajar" value="{{ old('tenaga_pengajar', $tabelJabatanDosen->tenaga_pengajar) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah') ? 'is-invalid' : '' }}" type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $tabelJabatanDosen->jumlah) }}" step="1">
