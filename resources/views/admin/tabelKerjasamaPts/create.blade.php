...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tabelKerjasamaPt.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tabel-kerjasama-pts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lembaga') ? 'is-invalid' : '' }}" type="text" name="lembaga" id="lembaga" value="{{ old('lembaga', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('bentuk') ? 'is-invalid' : '' }}" name="bentuk" id="bentuk">{{ old('bentuk') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('berlaku') ? 'is-invalid' : '' }}" type="text" name="berlaku" id="berlaku" value="{{ old('berlaku', '') }}">
