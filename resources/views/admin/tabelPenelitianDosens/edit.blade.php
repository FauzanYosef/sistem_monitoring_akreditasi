...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tabelPenelitianDosen.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tabel-penelitian-dosens.update", [$tabelPenelitianDosen->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sumber_biaya') ? 'is-invalid' : '' }}" name="sumber_biaya" id="sumber_biaya">
                    ...
                    @foreach(App\Models\TabelPenelitianDosen::SUMBER_BIAYA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sumber_biaya', $tabelPenelitianDosen->sumber_biaya) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_judul_1') ? 'is-invalid' : '' }}" type="number" name="jml_judul_1" id="jml_judul_1" value="{{ old('jml_judul_1', $tabelPenelitianDosen->jml_judul_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_judul_2') ? 'is-invalid' : '' }}" type="number" name="jml_judul_2" id="jml_judul_2" value="{{ old('jml_judul_2', $tabelPenelitianDosen->jml_judul_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_judul_3') ? 'is-invalid' : '' }}" type="number" name="jml_judul_3" id="jml_judul_3" value="{{ old('jml_judul_3', $tabelPenelitianDosen->jml_judul_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah') ? 'is-invalid' : '' }}" type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $tabelPenelitianDosen->jumlah) }}" step="1">
