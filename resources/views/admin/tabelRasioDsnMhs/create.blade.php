...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tabelRasioDsnMh.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tabel-rasio-dsn-mhs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_ta') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_ta" id="jml_mhs_ta" value="{{ old('jml_mhs_ta', '') }}" step="1">
