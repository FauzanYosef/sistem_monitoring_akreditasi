...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tabelRekognisiDosen.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tabel-rekognisi-dosens.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="nama_dosen">{{ trans('cruds.tabelRekognisiDosen.fields.nama_dosen') }}</label>
                <input class="form-control {{ $errors->has('nama_dosen') ? 'is-invalid' : '' }}" type="text" name="nama_dosen" id="nama_dosen" value="{{ old('nama_dosen', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keahlian') ? 'is-invalid' : '' }}" type="text" name="keahlian" id="keahlian" value="{{ old('keahlian', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('rekognisi') ? 'is-invalid' : '' }}" name="rekognisi" id="rekognisi">{{ old('rekognisi') }}</textarea>
