...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tabelSeleksimhsbaru.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tabel-seleksimhsbarus.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tahun_akademik') ? 'is-invalid' : '' }}" type="text" name="tahun_akademik" id="tahun_akademik" value="{{ old('tahun_akademik', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('daya_tampung') ? 'is-invalid' : '' }}" type="number" name="daya_tampung" id="daya_tampung" value="{{ old('daya_tampung', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_calon_pendaftar') ? 'is-invalid' : '' }}" type="number" name="jumlah_calon_pendaftar" id="jumlah_calon_pendaftar" value="{{ old('jumlah_calon_pendaftar', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_lulus_seleksi') ? 'is-invalid' : '' }}" type="number" name="jumlah_lulus_seleksi" id="jumlah_lulus_seleksi" value="{{ old('jumlah_lulus_seleksi', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_baru_reguler') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_baru_reguler" id="jml_mhs_baru_reguler" value="{{ old('jml_mhs_baru_reguler', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_transfer') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_transfer" id="jml_mhs_transfer" value="{{ old('jml_mhs_transfer', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_mhs_reguler') ? 'is-invalid' : '' }}" type="number" name="total_mhs_reguler" id="total_mhs_reguler" value="{{ old('total_mhs_reguler', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_mhs_transfer') ? 'is-invalid' : '' }}" type="number" name="total_mhs_transfer" id="total_mhs_transfer" value="{{ old('total_mhs_transfer', '') }}" step="1">
