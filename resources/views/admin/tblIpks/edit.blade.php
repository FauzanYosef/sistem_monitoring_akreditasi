...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblIpk.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-ipks.update", [$tblIpk->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('program_pendidikan') ? 'is-invalid' : '' }}" name="program_pendidikan" id="program_pendidikan">
                    ...
                    @foreach(App\Models\TblIpk::PROGRAM_PENDIDIKAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('program_pendidikan', $tblIpk->program_pendidikan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_ps') ? 'is-invalid' : '' }}" type="number" name="jumlah_ps" id="jumlah_ps" value="{{ old('jumlah_ps', $tblIpk->jumlah_ps) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_lulusan_2') ? 'is-invalid' : '' }}" type="number" name="jml_lulusan_2" id="jml_lulusan_2" value="{{ old('jml_lulusan_2', $tblIpk->jml_lulusan_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_lulusan_1') ? 'is-invalid' : '' }}" type="number" name="jml_lulusan_1" id="jml_lulusan_1" value="{{ old('jml_lulusan_1', $tblIpk->jml_lulusan_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_lulusan') ? 'is-invalid' : '' }}" type="number" name="jml_lulusan" id="jml_lulusan" value="{{ old('jml_lulusan', $tblIpk->jml_lulusan) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_ipk_2') ? 'is-invalid' : '' }}" type="number" name="average_ipk_2" id="average_ipk_2" value="{{ old('average_ipk_2', $tblIpk->average_ipk_2) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_ipk_1') ? 'is-invalid' : '' }}" type="number" name="average_ipk_1" id="average_ipk_1" value="{{ old('average_ipk_1', $tblIpk->average_ipk_1) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_ipk') ? 'is-invalid' : '' }}" type="number" name="average_ipk" id="average_ipk" value="{{ old('average_ipk', $tblIpk->average_ipk) }}" step="0.01">
