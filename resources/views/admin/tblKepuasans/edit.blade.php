...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblKepuasan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-kepuasans.update", [$tblKepuasan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('aspek_penilaian') ? 'is-invalid' : '' }}" name="aspek_penilaian" id="aspek_penilaian">
                    ...
                    @foreach(App\Models\TblKepuasan::ASPEK_PENILAIAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('aspek_penilaian', $tblKepuasan->aspek_penilaian) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hasil_penilaian_4') ? 'is-invalid' : '' }}" type="number" name="hasil_penilaian_4" id="hasil_penilaian_4" value="{{ old('hasil_penilaian_4', $tblKepuasan->hasil_penilaian_4) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hasil_penilaian_3') ? 'is-invalid' : '' }}" type="number" name="hasil_penilaian_3" id="hasil_penilaian_3" value="{{ old('hasil_penilaian_3', $tblKepuasan->hasil_penilaian_3) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hasil_penilaian_2') ? 'is-invalid' : '' }}" type="number" name="hasil_penilaian_2" id="hasil_penilaian_2" value="{{ old('hasil_penilaian_2', $tblKepuasan->hasil_penilaian_2) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hasil_penilaian') ? 'is-invalid' : '' }}" type="number" name="hasil_penilaian" id="hasil_penilaian" value="{{ old('hasil_penilaian', $tblKepuasan->hasil_penilaian) }}" step="0.01">
