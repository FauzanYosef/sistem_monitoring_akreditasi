...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tblLamaStudi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-lama-studis.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_masa_2') ? 'is-invalid' : '' }}" type="number" name="average_masa_2" id="average_masa_2" value="{{ old('average_masa_2', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_masa_1') ? 'is-invalid' : '' }}" type="number" name="average_masa_1" id="average_masa_1" value="{{ old('average_masa_1', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_masa') ? 'is-invalid' : '' }}" type="number" name="average_masa" id="average_masa" value="{{ old('average_masa', '') }}" step="0.01">
