...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblPenggunaanDana.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-penggunaan-danas.update", [$tblPenggunaanDana->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="jenis_penggunaan">{{ trans('cruds.tblPenggunaanDana.fields.jenis_penggunaan') }}</label>
                <input class="form-control {{ $errors->has('jenis_penggunaan') ? 'is-invalid' : '' }}" type="text" name="jenis_penggunaan" id="jenis_penggunaan" value="{{ old('jenis_penggunaan', $tblPenggunaanDana->jenis_penggunaan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_ts_2') ? 'is-invalid' : '' }}" type="number" name="jml_ts_2" id="jml_ts_2" value="{{ old('jml_ts_2', $tblPenggunaanDana->jml_ts_2) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_dana_ts_1') ? 'is-invalid' : '' }}" type="number" name="jml_dana_ts_1" id="jml_dana_ts_1" value="{{ old('jml_dana_ts_1', $tblPenggunaanDana->jml_dana_ts_1) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_dana_ts') ? 'is-invalid' : '' }}" type="number" name="jml_dana_ts" id="jml_dana_ts" value="{{ old('jml_dana_ts', $tblPenggunaanDana->jml_dana_ts) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml') ? 'is-invalid' : '' }}" type="number" name="jml" id="jml" value="{{ old('jml', $tblPenggunaanDana->jml) }}" step="0.01">
                @if($errors->has('jml'))
