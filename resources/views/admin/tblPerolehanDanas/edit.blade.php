...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblPerolehanDana.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-perolehan-danas.update", [$tblPerolehanDana->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sumber_dana') ? 'is-invalid' : '' }}" name="sumber_dana" id="sumber_dana">
                    ...
                    @foreach(App\Models\TblPerolehanDana::SUMBER_DANA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sumber_dana', $tblPerolehanDana->sumber_dana) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jenis_dana') ? 'is-invalid' : '' }}" type="text" name="jenis_dana" id="jenis_dana" value="{{ old('jenis_dana', $tblPerolehanDana->jenis_dana) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_ts_2') ? 'is-invalid' : '' }}" type="number" name="jml_ts_2" id="jml_ts_2" value="{{ old('jml_ts_2', $tblPerolehanDana->jml_ts_2) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_dana_ts_1') ? 'is-invalid' : '' }}" type="number" name="jml_dana_ts_1" id="jml_dana_ts_1" value="{{ old('jml_dana_ts_1', $tblPerolehanDana->jml_dana_ts_1) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_dana_ts') ? 'is-invalid' : '' }}" type="number" name="jml_dana_ts" id="jml_dana_ts" value="{{ old('jml_dana_ts', $tblPerolehanDana->jml_dana_ts) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml') ? 'is-invalid' : '' }}" type="number" name="jml" id="jml" value="{{ old('jml', $tblPerolehanDana->jml) }}" step="0.01">
                @if($errors->has('jml'))
