...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tblPersentaseKerja.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-persentase-kerjas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('persen_4') ? 'is-invalid' : '' }}" type="number" name="persen_4" id="persen_4" value="{{ old('persen_4', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('persen_3') ? 'is-invalid' : '' }}" type="number" name="persen_3" id="persen_3" value="{{ old('persen_3', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('persen_2') ? 'is-invalid' : '' }}" type="number" name="persen_2" id="persen_2" value="{{ old('persen_2', '') }}" step="0.01">
