...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblPublikasiIlmiah.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-publikasi-ilmiahs.update", [$tblPublikasiIlmiah->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('jenis_publikasi') ? 'is-invalid' : '' }}" name="jenis_publikasi" id="jenis_publikasi">
                    ...
                    @foreach(App\Models\TblPublikasiIlmiah::JENIS_PUBLIKASI_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('jenis_publikasi', $tblPublikasiIlmiah->jenis_publikasi) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_judul_1') ? 'is-invalid' : '' }}" type="number" name="jml_judul_1" id="jml_judul_1" value="{{ old('jml_judul_1', $tblPublikasiIlmiah->jml_judul_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_judul_2') ? 'is-invalid' : '' }}" type="number" name="jml_judul_2" id="jml_judul_2" value="{{ old('jml_judul_2', $tblPublikasiIlmiah->jml_judul_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_judul_3') ? 'is-invalid' : '' }}" type="number" name="jml_judul_3" id="jml_judul_3" value="{{ old('jml_judul_3', $tblPublikasiIlmiah->jml_judul_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah') ? 'is-invalid' : '' }}" type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $tblPublikasiIlmiah->jumlah) }}" step="1">
