...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tblRasioLulu.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-rasio-lulus.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('prodi') ? 'is-invalid' : '' }}" name="prodi" id="prodi">
                    ...
                    @foreach(App\Models\TblRasioLulu::PRODI_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('prodi', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('prodi'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tahun_masuk') ? 'is-invalid' : '' }}" name="tahun_masuk" id="tahun_masuk">
                    ...
                    @foreach(App\Models\TblRasioLulu::TAHUN_MASUK_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tahun_masuk', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_6') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_6" id="jml_mhs_6" value="{{ old('jml_mhs_6', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_5') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_5" id="jml_mhs_5" value="{{ old('jml_mhs_5', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_4') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_4" id="jml_mhs_4" value="{{ old('jml_mhs_4', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_3') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_3" id="jml_mhs_3" value="{{ old('jml_mhs_3', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_2') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_2" id="jml_mhs_2" value="{{ old('jml_mhs_2', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs_1') ? 'is-invalid' : '' }}" type="number" name="jml_mhs_1" id="jml_mhs_1" value="{{ old('jml_mhs_1', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_mhs') ? 'is-invalid' : '' }}" type="number" name="jml_mhs" id="jml_mhs" value="{{ old('jml_mhs', '') }}" step="1">
