...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tblRefPenilaian.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-ref-penilaians.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_lulusan_4') ? 'is-invalid' : '' }}" type="number" name="jml_lulusan_4" id="jml_lulusan_4" value="{{ old('jml_lulusan_4', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_lulusan_3') ? 'is-invalid' : '' }}" type="number" name="jml_lulusan_3" id="jml_lulusan_3" value="{{ old('jml_lulusan_3', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jwb_lulusan_4') ? 'is-invalid' : '' }}" type="number" name="jwb_lulusan_4" id="jwb_lulusan_4" value="{{ old('jwb_lulusan_4', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jwb_lulusan_3') ? 'is-invalid' : '' }}" type="number" name="jwb_lulusan_3" id="jwb_lulusan_3" value="{{ old('jwb_lulusan_3', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jwb_lulusan_2') ? 'is-invalid' : '' }}" type="number" name="jwb_lulusan_2" id="jwb_lulusan_2" value="{{ old('jwb_lulusan_2', '') }}" step="1">
