...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblReferensi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-referensis.update", [$tblReferensi->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('program_pendidikan') ? 'is-invalid' : '' }}" name="program_pendidikan" id="program_pendidikan">
                    ...
                    @foreach(App\Models\TblReferensi::PROGRAM_PENDIDIKAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('program_pendidikan', $tblReferensi->program_pendidikan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banyak_lulusan_3') ? 'is-invalid' : '' }}" type="number" name="banyak_lulusan_3" id="banyak_lulusan_3" value="{{ old('banyak_lulusan_3', $tblReferensi->banyak_lulusan_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banyak_lulusan_2') ? 'is-invalid' : '' }}" type="number" name="banyak_lulusan_2" id="banyak_lulusan_2" value="{{ old('banyak_lulusan_2', $tblReferensi->banyak_lulusan_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banyak_lulusan') ? 'is-invalid' : '' }}" type="number" name="banyak_lulusan" id="banyak_lulusan" value="{{ old('banyak_lulusan', $tblReferensi->banyak_lulusan) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_lulusan_3') ? 'is-invalid' : '' }}" type="number" name="nilai_lulusan_3" id="nilai_lulusan_3" value="{{ old('nilai_lulusan_3', $tblReferensi->nilai_lulusan_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_lulusan_2') ? 'is-invalid' : '' }}" type="number" name="nilai_lulusan_2" id="nilai_lulusan_2" value="{{ old('nilai_lulusan_2', $tblReferensi->nilai_lulusan_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nilai_lulusan_1') ? 'is-invalid' : '' }}" type="number" name="nilai_lulusan_1" id="nilai_lulusan_1" value="{{ old('nilai_lulusan_1', $tblReferensi->nilai_lulusan_1) }}" step="1">
