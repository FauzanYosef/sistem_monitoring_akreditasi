...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblTempatKerja.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-tempat-kerjas.update", [$tblTempatKerja->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('program_pendidikan') ? 'is-invalid' : '' }}" name="program_pendidikan" id="program_pendidikan">
                    ...
                    @foreach(App\Models\TblTempatKerja::PROGRAM_PENDIDIKAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('program_pendidikan', $tblTempatKerja->program_pendidikan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jml_lulusan') ? 'is-invalid' : '' }}" type="number" name="jml_lulusan" id="jml_lulusan" value="{{ old('jml_lulusan', $tblTempatKerja->jml_lulusan) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tingkat_1') ? 'is-invalid' : '' }}" type="number" name="tingkat_1" id="tingkat_1" value="{{ old('tingkat_1', $tblTempatKerja->tingkat_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tingkat_2') ? 'is-invalid' : '' }}" type="number" name="tingkat_2" id="tingkat_2" value="{{ old('tingkat_2', $tblTempatKerja->tingkat_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tingkat_3') ? 'is-invalid' : '' }}" type="number" name="tingkat_3" id="tingkat_3" value="{{ old('tingkat_3', $tblTempatKerja->tingkat_3) }}" step="1">
