...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tblWaktuLulusan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tbl-waktu-lulusans.update", [$tblWaktuLulusan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('program_pendidikan') ? 'is-invalid' : '' }}" name="program_pendidikan" id="program_pendidikan">
                    ...
                    @foreach(App\Models\TblWaktuLulusan::PROGRAM_PENDIDIKAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('program_pendidikan', $tblWaktuLulusan->program_pendidikan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_tunggu_4') ? 'is-invalid' : '' }}" type="number" name="average_tunggu_4" id="average_tunggu_4" value="{{ old('average_tunggu_4', $tblWaktuLulusan->average_tunggu_4) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_tunggu_3') ? 'is-invalid' : '' }}" type="number" name="average_tunggu_3" id="average_tunggu_3" value="{{ old('average_tunggu_3', $tblWaktuLulusan->average_tunggu_3) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_tunggu_2') ? 'is-invalid' : '' }}" type="number" name="average_tunggu_2" id="average_tunggu_2" value="{{ old('average_tunggu_2', $tblWaktuLulusan->average_tunggu_2) }}" step="0.01">
